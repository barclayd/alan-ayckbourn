...
source: "http://confusions.alanayckbourn.net/styled-10/"
order: 1145
play: "confusions"
---

*Alan Ayckbourn's Archivist Simon Murgatroyd's answers some of the most frequently asked questions about Alan Ayckbourn's Confusions. If you have a question about this or any other of Alan Ayckbourn's plays, you can contact the website via the* ***[Contact Us](/)*** *page.*
...
Not really. Whilst, theoretically, you could perform *Confusions* with all 22 roles (20 characters) being taken by different actors, the play was written specifically for five actors as *Confusions* was intended to be a acting showcase with five actors playing multiple roles. Whilst different cast-size permutations have been used in amateur productions over the years, it is Alan's Ayckbourn's preference and hope that it is performed with just the specified number of five actors.

**Am I able to perform the *Confusions* plays individually (for example as part of a drama festival)?**  
Yes, you can perform the plays individually. Licenses for individual performance can be obtained as per normal via **[Concord Theatricals](http://www.concordtheatricals.co.uk/p/939/confusions/)**.
...
**When is *Confusions* set?**  
*Confusions* - like the vast majority of Alan Ayckbourn's plays - is set in the approximate period of when it was written. I.e. the mid 1970s. The playwright firmly believes the majority of his plays are period pieces which should be performed in those same periods as they reflect the attitudes and society of that time. It makes no sense to move the play - particularly to update or modernise them - because they will no longer be credible. The attitudes of the characters are firmly based in the era when they are written.  
If a need is felt to alter a play - such as moving out of its time -period - the playwright suggests the question should then be asked, have you chosen the right play to perform?
