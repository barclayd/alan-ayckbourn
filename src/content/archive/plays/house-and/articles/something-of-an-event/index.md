...
○ [The Middle Of The Ring (Paul Allen)](/plays/house-and/articles/the-middle-of-the-ring)
...
Since then, Alan has written the trilogy *Damsels In Distress*, which comprises three plays utilising the same set (representing different locations) and the same company (playing different roles). Originally conceived as a duo of plays (*GamePlan* and *FlatSpin*), they were joined during rehearsals by *RolePlay*, making it even bigger than planned.
