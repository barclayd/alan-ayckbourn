...
**Availability:** *Love After All* is not available for production.

**Note:** This synopsis is based on the original 1959 production of the play which is set in 1910, rather than the revised 1960 production which was moved to a contemporary setting. The differences between the two scripts are largely superficial with the plot remaining the same (see note below).
...
○ Scrimes *(A miser of eighty-three)*  
○ Angelica *(His daughter)*  
○ Minta *(Her maid)*  
○ Rupert Hodge *(Her weak-headed, aristocratic suitor)*  
○ Jim Jones *(A constant lover)*

*These names refer to the original 1959 play rather than the revised 1960 version. For reference the altered names are listed below.*

○ Scrimes / Walter Bagwell  
○ Minta / Ida  
○ Angelica / Angela  
○ Jim Jones / Peter Jones  
○ Rupert Hodge (same)
